...
export class WebsiteService {
    ...
    //     doLogin(login: ILogin): Observable<ICurrentUser> {
    //     return this.http
    //         .put<HttpResponse<ICurrentUser>>(this.loginUrl, login, { observe: 'response' })
    //         .pipe(
    //             tap(val => this.log('doLogin response = ' + JSON.stringify(val, null, 4))),
